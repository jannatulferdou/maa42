...
const styles = StyleSheet.create({
  ...
  searchBox: { height: 44, borderRadius: 10, borderWidth: 1, borderColor: "#CFD8DC", backgroundColor: Colors.light.white, flexDirection: "row", alignItems: "center", paddingHorizontal: 16, marginBottom: 28 },
  searchInput: { flex: 1, marginLeft: 10, fontSize: 15 },
  date: { fontSize: 14, fontWeight: "800", color: Colors.light.text, marginBottom: 13, marginTop: 4 },
  chatCard: { height: 59, backgroundColor: Colors.light.white, borderRadius: 10, flexDirection: "row", alignItems: "center", paddingHorizontal: 12, marginBottom: 13 },
  chatIcon: { width: 36, height: 36, borderRadius: 8, backgroundColor: "#E1F7F3", alignItems: "center", justifyContent: "center", marginRight: 12 },
  chatTitle: { flex: 1, fontSize: 15, fontWeight: "800", color: Colors.light.text },
  empty: { textAlign: "center", marginTop: 40, color: Colors.light.textSecondary, fontSize: 15 },
});
